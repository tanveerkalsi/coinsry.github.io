				...
				<div class="panel-body">
					<sf:form class="form-horizontal" modelAttribute="product" action="${contextRoot}/manage/product" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="text" path="year" class="form-control"
									placeholder="year" /> 
								<sf:errors path="year" cssClass="help-block" element="em"/>	
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-4">Details</label>
							<div class="col-md-8">
								<sf:input type="text" path="detail" class="form-control"
									placeholder="details" /> 
								<sf:errors path="detail" cssClass="help-block" element="em"/>	
							</div>
						</div>
